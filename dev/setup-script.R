...
usethis::use_git_config(
  scope = "project",
  user.name = "Luca Aiello",
  user.email = "l.aiello4@campus.unimib.it"
)
usethis::use_git()
...
usethis::use_description(
  list(
    ...
    URL = "https://github.com/lucaaiello/myShapes"
  )
)
...
#
#   Install Package:           'Ctrl + Shift + B' the current package we are working on
